...
import {AppBar, Toolbar, Divider, Paper, IconButton} from '@mui/material'
...
export const NavBar = () => {
    return (
        <AppBar elevation={7} position='fixed' sx={{left: 0, top: 'auto', bottom: 20}} className='bg-danger navbar'>
